...
column_coord_file = '' #path to file where columns (e.g. party accounts or MPs) are embedded
...
row_coord_file = '' #path to file where columns (e.g. followers of MPs) are embedded
